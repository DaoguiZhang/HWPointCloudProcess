...
public:
	...
	//bool trackFrameViews(FrameHessian* newFrameHessian, std::vector<IOWrap::Output3DWrapper*> &wraps);
	bool trackFrameNoViews(FrameHessian* newFrameHessian);

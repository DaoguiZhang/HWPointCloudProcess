...
bool CoarseInitializer::trackFrameNoViews(FrameHessian* newFrameHessian)
{
	newFrame = newFrameHessian;
...
void CoarseInitializer::debugPlotImages(int lvl)
{
	bool needCall = false;
...
void CoarseInitializer::setFirst(	CalibHessian* HCalib, FrameHessian* newFrameHessian)
{
	...
	for(int lvl=0; lvl<pyrLevelsUsed; lvl++)
	{
		...
		if (lvl == 0)
		{
			...
			npts = sel.makeMapsNoConst(firstFrame, statusMap, densities[lvl] * w[0] * h[0], 1, false, 2);
		}	
		else

...
//local
#include <Common/GenericProgressCallback.h>
#include <Common/ReferenceCloud.h>
#include <Common/ScalarField.h>
													...
													DgmOctree* theCloudOctree/*=0*/)
{
	...
	/*printf("the best octree level is: %d\n", octreeLevel);
	printf("the theGradientNorms size is: %d\n", theCloud->size());
	system("pause");*/
													...
													NormalizedProgress* nProgress/*=0*/)
{
	...
	printf("the cell point size is: %d\n", n);
	...
	for (unsigned i = 0; i < n; ++i)
	{
		...
		int idx_temp = cell.points->getPointGlobalIndex(0);
		printf("the idx temp is: %d\n", idx_temp);
		printf("i: %d\n", i);
		system("pause");
		...
		if (theGradientNorms)
		{
			printf("the cell.points->getPointGlobalIndex(i) is: %d\n", cell.points->getPointGlobalIndex(i));
			printf("the gN is: %f\n", gN);
			system("pause");
			...
			printf("the theGradientNorms 1111111111111\n");
			system("pause");
		}
		else
		{

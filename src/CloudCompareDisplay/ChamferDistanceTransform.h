...
//Local
#include "CloudCompareDisplay/Grid3D.h"
#include "CloudCompareDisplay/MathTools.h"
...
**/
//CC_CORE_LIB_API
class  ChamferDistanceTransform : public Grid3D<unsigned short>, public MathTools
{

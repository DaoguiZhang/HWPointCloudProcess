...
#include <CloudCompareDisplay/PointProjectionTools.h>
#include <Common/ReferenceCloud.h>
#include <CloudCompareDisplay/Neighbourhood.h>
...
{
	//printf("mesh mesh opengl buffer\n");
	...
	//printf("mesh mesh opengl buffer0\n");

	//get the set of OpenGL functions (version 2.1)
	QOpenGLFunctions_2_1* glFunc = context.glFunctions<QOpenGLFunctions_2_1>();
	assert(glFunc != nullptr);

	//printf("mesh mesh opengl buffer1\n");
	...
	//test
	//printf("mesh mesh opengl buffer2\n");
	//end test
	...
	if (MACRO_Draw3D(context))
	{
		...
		//printf("mesh mesh opengl buffer3\n");
		if (triNum == 0)
		{
			return;
		}

...
//Local
#include "CloudCompareDisplay/ccColorScale.h"
#include "CloudCompareDisplay/ccNormalVectors.h"
#include "CloudCompareDisplay/ccWaveform.h"
...
**/
//QCC_DB_LIB_API
class  ccPointCloud : public CCLib::PointCloudTpl<ccGenericPointCloud>
{
public:
	//! Base class (shortcut)
...
protected: //waveform (e.g. from airborne scanners)
	...
	public:
		std::vector<int> pc_deleted_idx_;

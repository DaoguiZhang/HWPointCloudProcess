...
void ArcBall_t::upstate()
{
	...
	{//正在拖动  
		...
		{
			Point2fSub(&this->MousePt, &this->LastPt);
			this->translate.s.X = this->lastTranslate.s.X + this->MousePt.s.X * this->AdjustWidth * this->scale * 50;
			this->translate.s.Y = this->lastTranslate.s.Y - this->MousePt.s.Y * this->AdjustHeight * this->scale * 50;
		}
